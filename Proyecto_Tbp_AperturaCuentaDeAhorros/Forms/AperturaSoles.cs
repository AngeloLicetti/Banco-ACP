...
{
    public partial class AperturaSoles : Form
    {
        public AperturaSoles()
        {
            InitializeComponent();
        }
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            if (txtNombres.Text != "" && txtApellidos.Text != "" && txtMontoInicial.Text != "" && txtNombreDeUsuario.Text != "" && txtContraseña.Text != "")
            {
                ...
                CuentaAperturada CuentaSolesCreada = new CuentaAperturada(nuevaCuenta,Proceso.n);
                CuentaSolesCreada.Show();
                this.Close();
            }
            else
            {
